            ...
            <div class="row">
                ...
                <form class="form-inline" role="form" action="../../../controller/add_teacherController.php" method="post" enctype="multipart/form-data" onsubmit="return valid()">
                    <div class="form-group col-md-4" style="padding: 5px">
                        <label class="col-sm-10 control-label no-padding-right">Full Name</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" style="width: 100%" name="full_name" placeholder="Full Name">
                        </div>
                    </div>
                    <div class="form-group col-md-4" style="padding: 5px">
