        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="message col-md-12">
                    <div class="alert alert-warning col-md-4 col-md-offset-4 text-center" id="alert-msg"
                         style="display: none" role="alert">
                        <strong>Failed!</strong> You Can not Use any tag or spacial characters.
                    </div>
                </div>

                <form action="../../../controller/add_book_category.php" method="post" role="form"
                      class="col-md-6 col-md-offset-3 form" onsubmit="return valid()">
                    ...
                    <div class="form-group" style="padding: 25px 5px;">
                        ...
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-primary" style="border-radius: 25px">Add Category
                            </button>
                        </div>
                    </div>
                    <script>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" data-toggle="modal"
                                   data-target="#exampleModalCenter<?php echo $oneBooks->cat_id ?>">Edit</a>
                                <div class="modal fade" id="exampleModalCenter<?php echo $oneBooks->cat_id ?>"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="../../../controller/updateCategoryCTRL.php?cat_id=<?php echo $oneBooks->cat_id ?>"
                                                  method="post">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Category Name</label>
                                                        <input type="text" class="form-control" name="cat_name"
                                                               value="<?php echo $oneBooks->cat_name ?>">
                                                    </div>
                                                </div>
