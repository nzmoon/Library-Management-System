                ...
                <table class="table" style="font-size: 16px">
                    ...
                    <?php $serial =0; foreach ($allWriter as $Writer){?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter<?php echo $Writer->id?>">Edit</button>
                                <div class="modal fade" id="exampleModalCenter<?php echo $Writer->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Edit Writer</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="../../../controller/updateWriterCTRL.php?id=<?php echo $Writer->id?>" method="post">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Writer Name</label>
                                                        <input type="text" class="form-control" name="writer_name" value="<?php echo $Writer->writer_name?>">
                                                    </div>
                                                </div>
